...
class StoryHandler(Handler):
    """The Story handler class. Used to handle new or updated stories.
    ...
    Parameters:
        callback (``Callable``):
            Pass a function that will be called when a new Story arrives. It takes *(client, story)*
    ...
    Other parameters:
        ...
        story (:obj:`~pyrogram.types.StoryItem`):
            The received story.
    """
